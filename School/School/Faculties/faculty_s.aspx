...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="grd_faculties" AutoGenerateColumns ="false" runat="server" OnRowCommand="grd_faculties_RowCommand">
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:ImageButton ID="Editbtn" runat="server" ImageUrl="/Images/Edit.png" Heigh ="20px" Width="20px" 
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:ImageButton ID="Deletebtn" runat="server" ImageUrl="/Images/Delete.png" Heigh ="20px" Width="20px" 
